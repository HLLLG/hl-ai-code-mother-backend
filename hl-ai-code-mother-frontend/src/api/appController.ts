...
/** 此处后端没有提供注释 GET /app/get/app/download */
export async function getDownloadCountByApp(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getDownloadCountByAppParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseInteger>('/app/get/app/download', {
    method: 'GET',
    params: {
      ...params,
    },
