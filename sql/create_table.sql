...
(
    ...
    currentVersionId bigint                             null comment '当前生效的版本记录 id',
    priority         int      default 0                 not null comment '优先级',
    downloadCount    int      default 0                 not null comment '代码下载次数',
    ...
    INDEX idx_currentVersion (currentVersion),
    INDEX idx_currentVersionId (currentVersionId)
