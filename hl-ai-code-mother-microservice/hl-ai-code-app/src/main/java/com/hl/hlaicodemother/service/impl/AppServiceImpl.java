...
import com.hl.hlaicodemother.innerservice.InnerScreenshotMessageProducer;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    @DubboReference
    private InnerScreenshotMessageProducer screenshotMessageProducer;
    ...
    public void generateAppScreenshotAsync(Long appId, String appDeployUrl) {
        screenshotMessageProducer.sendScreenshotTask(new com.hl.hlaicodemother.model.ScreenshotTaskMessage(appId, appDeployUrl));
    }
